...
class MockIInteger(MagicMock):
    pass


class MockIFloat(MagicMock):
    pass


class MockIString(MagicMock):
    pass


class MockIBoolean(MagicMock):
    pass


class MockIEnumeration(MagicMock):
    pass
...
class MockGenAPI:
    ...
    class _EInterfaceType:
        intfIInteger, intfIFloat, intfIString, intfIBoolean, intfIEnumeration = range(
            1, 6
        )
